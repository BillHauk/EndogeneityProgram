...
global ndgresidcorr=(abs(R[3,1])*R[3,1]*$skresidcorr+abs(R[3,2])*R[3,2]*$shresidcorr)/(abs(R[3,1])+abs(R[3,2]))
global yiniresidcorr=(abs(R[4,1])*R[4,1]*$skresidcorr+abs(R[4,2])*R[4,2]*$shresidcorr)/(abs(R[4,1])+abs(R[4,2]))
global feresidcorr=(abs(R[5,1])*R[5,1]*$skresidcorr+abs(R[5,2])*R[5,2]*$shresidcorr)/(abs(R[5,1])+abs(R[5,2]))
