...
global shresidcorr=(abs(R[2,1])*R[2,1]*$skresidcorr+abs(R[2,3])*R[2,3]*$ndgresidcorr)/(abs(R[2,1])+abs(R[2,3]))
global yiniresidcorr=(abs(R[4,1])*R[4,1]*$skresidcorr+abs(R[4,3])*R[4,3]*$ndgresidcorr)/(abs(R[4,1])+abs(R[4,3]))
global feresidcorr=(abs(R[5,1])*R[5,1]*$skresidcorr+abs(R[5,3])*R[5,3]*$ndgresidcorr)/(abs(R[5,1])+abs(R[5,3]))
